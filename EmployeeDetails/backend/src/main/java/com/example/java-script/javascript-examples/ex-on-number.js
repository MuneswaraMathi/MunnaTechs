...
console.log("method & variabled in Number class");

let numberInstance = new Number(123);
console.log("numberInstance is: ", numberInstance);

console.log("numberInstance value is: ", numberInstance.valueOf());

console.log("numberInstance toPrecision is: ", numberInstance.toPrecision(5));

let miniSafeValue = Number.MIN_SAFE_INTEGER;
console.log("miniSafeValue is: ", miniSafeValue);

let maxSafeValue = Number.MAX_SAFE_INTEGER;
console.log("maxSafeValue is: ", maxSafeValue);
...
let infinityValue = Number.POSITIVE_INFINITY;
console.log("infinityValue is: ", infinityValue);

let negativeInfinityValue = Number.NEGATIVE_INFINITY;
console.log("negativeInfinityValue is: ", negativeInfinityValue);

let nanValue = Number.NaN;
console.log("nanValue is: ", nanValue);

let isNanValue = Number.isNaN(minValue);
console.log("isNanValue is: ", isNanValue);

let isNumber = Number.isSafeInteger(minValue);
